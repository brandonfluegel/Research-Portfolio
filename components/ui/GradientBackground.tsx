export default function GradientBackground() {
  return (
    <div className="ambient-background fixed inset-0 -z-10 overflow-hidden bg-black contain-strict">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] md:w-[80vw] h-[500px] md:h-[80vw] bg-zinc-900/20 blur-[100px] md:blur-[150px] rounded-full" />
    </div>
  );
}