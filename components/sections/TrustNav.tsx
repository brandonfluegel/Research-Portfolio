...
const companies = [
  { name: "Amazon", logo: "/assets/amazon-logo.png", id: "amazon-section", sizing: "h-5 md:h-8 w-auto", mobileSizing: "h-4 w-auto" },
  { name: "Sling", logo: "/assets/Sling-logo.png", id: "sling-section", sizing: "h-6 md:h-9 w-auto", mobileSizing: "h-4 w-auto" },
  { name: "NASA", logo: "/assets/nasa-logo.png", id: "nasa-section", sizing: "h-8 md:h-10 w-auto", mobileSizing: "h-6 w-auto" },
  { name: "Uber", logo: "/assets/uber-logo.png", id: "uber-section", sizing: "h-5 md:h-8 w-auto", mobileSizing: "h-3.5 w-auto" },
  { name: "Mercedes", logo: "/assets/benz.png", id: "mercedes-section", sizing: "h-8 md:h-10 w-auto", mobileSizing: "h-6 w-auto" },
];
      ...
      <div className="flex md:hidden justify-between items-center px-4">
        {companies.map((company) => (
          <a
            ...
            className={`group relative flex flex-col items-center gap-1.5 transition-all duration-300 cursor-pointer tap-highlight-transparent active:scale-95 ${
