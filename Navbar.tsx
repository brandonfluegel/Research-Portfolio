...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between h-14 relative">
        
        {/* LOGO & NAME - Always on the left now */}
        <div className="flex items-center gap-3 z-50 group cursor-pointer relative">
          <Link 
            href="/" 
        ...
        <button
          className="flex flex-col space-y-1.5 z-50 p-2 hover:opacity-80 transition-opacity"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center h-screen w-screen"
          >
