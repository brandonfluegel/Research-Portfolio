...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen cursor-none px-4 sm:px-8 bg-black overflow-hidden selection:bg-white/20">
      ...
      {/* Hero Section */}
      {/* FIX: pt-36 on mobile to clear the centered navbar. Reduced min-h to pull content up. */}
      <section className="relative w-full flex flex-col items-center justify-center min-h-[50vh] md:min-h-[65vh] pt-36 pb-8 md:pt-48 md:pb-0 px-4">
        <div className="w-full flex flex-col items-center justify-center mx-auto relative z-10 px-2 sm:px-4 md:px-8">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            // FIX: text-3xl on mobile + text-balance for perfect wrapping
      ...
      {/* Trust Navigation Bar - Infinite Ticker */}
      <TrustNav />

      {/* Project Sections */}
      {/* FIX: mt-32 pushes the first project down so the hero breathes */}
