...
const PAIRS = [
  ...
  },
  {
    ...
    scientificFoundation: <>Merges Fluegel's HF <strong>Transparency of Intent</strong> with Google's <strong>Data and Model Alignment</strong>. Misalignment often stems from the agent failing to verify ambiguous goals before committing to action.</>,
    questions: [
  ...
  },
  {
    ...
    severity: "High Risk",
    severityLevel: "high",
    scientificFoundation: <>Synthesizes Fluegel's HF <strong>Directability</strong> principle, Dibia's <strong>Interruptibility</strong>, and Google's <strong>User Autonomy</strong>. True partnership requires shared initiative and seamless mid-flight corrections.</>,
    questions: [
  ...
  },
  {
    ...
    severity: "Catastrophic Trust Failure",
    severityLevel: "critical",
    scientificFoundation: <>Merges Fluegel's HF <strong>Calibrated Trust</strong> with Google's <strong>Evolving Safety</strong> framework. Trust must be earned proportionately; expressing appropriate doubt prevents catastrophic over-reliance.</>,
    questions: [
